...
drop policy if exists "Team members can view team messages"
...
drop policy if exists "Team members can send team messages"
on public.team_messages;
...
drop policy if exists "Team members can update their own team messages"
on public.team_messages;
...
drop policy if exists "Team members can delete their own team messages"
on public.team_messages;
